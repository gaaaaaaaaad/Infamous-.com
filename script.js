// Modern Enhanced JavaScript for Infamous Website
...
class AnimationController {
    ...
    addFloatingParticles(element) {
        // Removed for performance - particle effects cause lag
    }
...
class PageEnhancementController {
    ...
    setupPageTransitions() {
        // Disabled page transitions to prevent red screen issue
        // Links will navigate normally without transition effect
    }

    transitionToPage(href) {
        // Disabled to prevent red screen stuck issue
        window.location.href = href;
    }
    
    addLoadingAnimation() {
        // Removed page loader for better performance
        // Content loads immediately without delay
    }
    
    setupCursorEffects() {
        // Removed cursor trail effects for better performance
    }
...
class SalesController {
    ...
    addSocialProof() {
        // Removed social proof notifications for better performance
        // These create DOM elements every 15 seconds causing lag
    }
